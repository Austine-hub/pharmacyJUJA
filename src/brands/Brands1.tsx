...
import brandData from "../data/Brands.json"; // ✅ external JSON import

/**
 * Brands component
 * - Mirrors the brands listing page structure (alphabet index, grouped lists, search)
 * - Dynamically loads brands from brands.json (keeps code neat & scalable)
 * - No headers/footers included — just the component
 *
 * Source reference: BeyondRx "Brands" page
 */
...
export default function Brands1() {
  ...
  // ✅ Scroll into view when letter selected
  useEffect(() => {
